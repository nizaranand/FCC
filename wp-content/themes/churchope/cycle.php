	...
	<div class="row" id="jcyclemain_navigation"><a href="#" id="slide_prev"><span>&lt;</span></a><a href="#" id="slide_next"><span>&gt;</span></a></div>
		...
		<div id="jcyclemain">
			...
			while ($slider_query->have_posts()) : $slider_query->the_post();
				...
				$link_whole = (get_post_meta($post->ID, SHORTNAME . "_sliders_link_whole", true) ) ? get_post_meta($post->ID, SHORTNAME . "_sliders_link_whole", true) : NULL;
				...
				?>
						...
						<?php 
							if  ($link_whole && $link) {								
								echo '<a href="'.$link.'" class="slide_link_whole"></a>';
							}
						?>
					</div>
				</div>
