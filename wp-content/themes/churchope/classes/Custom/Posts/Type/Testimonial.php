...
class Custom_Posts_Type_Testimonial extends Custom_Posts_Type_Default
{
	...
	{
		$labels = array(
			'name'				=> __('Testimonials', 'churchope'),
			'all_items'			=> __('Testimonial Posts',  'churchope'),
			'singular_name'		=> __('Testimonial',  'churchope'),
	...
	{
		$labels = array(
			'name'					=> __('Testimonial Categories', 'churchope'),
			'singular_name'			=> __('Testimonial Category',  'churchope'),
