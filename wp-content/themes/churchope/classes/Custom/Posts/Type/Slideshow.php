...
//				$kgcs = get_the_terms(0, $this->getTaxonomyName());
	...
	protected function getPostLabeles()
	{
		...
		$labels = array(
			'name'				=> __('Slideshows', 'churchope'),
			'all_items'			=> __('Slideshow Posts',  'churchope'),
			'singular_name'		=> __('Slideshow',  'churchope'),
	...
	{
		$labels = array(
			'name'					=> __('Slideshow Categories',  'churchope'),
			'singular_name'			=> __('Slideshow Category',  'churchope'),
