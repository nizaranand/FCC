...
//				$kgcs = get_the_terms(0, $this->getTaxonomyName());
	...
	{
		$labels = array(
			'name'				=> __('Galleries',  'churchope'),
			'all_items'			=> __('Gallery Posts',  'churchope'),
			'singular_name'		=> __('Gallery',  'churchope'),
	...
	{
		$labels = array(
			'name'					=> __('Gallery Categories', 'churchope'),
			'singular_name'			=> __('Gallery Category',  'churchope'),
