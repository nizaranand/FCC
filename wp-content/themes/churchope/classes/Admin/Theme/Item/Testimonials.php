...
class Admin_Theme_Item_Testimonials extends Admin_Theme_Menu_Item
{
	public function __construct($parent_slug = '')
	{
		...
		$this->setPageTitle(__('Testimonials','churchope'));
		$this->setMenuTitle(__('Testimonials','churchope'));
	...
	public function init()
	{
		...
		$option->setName(__('Testimonials Settings','churchope'));
		$this->addOption($option);
		
		$option = new Admin_Theme_Element_Select();
		$option->setName(__('Sidebar position for testimonials listing','churchope'))
				->setDescription(__('Choose a sidebar position for testimonials listing','churchope'))
		...
		$option->setName(__('Sidebar for testimonials listing','churchope'))
				->setDescription(__('Choose a sidebar for testimonials listing','churchope'))
		...
		$option = new Admin_Theme_Element_Select();
		$option->setName(__('Sidebar position for single testimonial','churchope'))
				->setDescription(__('Choose a sidebar position for single testimonial','churchope'))
		...
		$option = new Admin_Theme_Element_SelectSidebar();
		$option->setName(__('Sidebar for single testimonial','churchope'))
				->setDescription(__('Choose a sidebar for single testimonial','churchope'))
		...
		$option->setName(__('Testimonial Post slug','churchope'))
		...
		$option = new Admin_Theme_Element_Text();
		$option->setName(__('Testimonial Tax slug','churchope'))
				->setDescription(__('Some description','churchope'))
