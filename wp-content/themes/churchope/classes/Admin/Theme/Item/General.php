...
class Admin_Theme_Item_General extends Admin_Theme_Menu_Item
{
	...
	public function init()
	{
		...
		$option->setDescription (__('Disable Google fonts','churchope'))
				->setName (__('Check to disable Google fonts','churchope'))
				->setCustomized()					// Show this element on WP Customize Admin menu
		...
		$option = new Admin_Theme_Element_Checkbox();
			$option->setName(__('Disable login page styling','churchope'))
					->setDescription(__('Check to disable login page styling','churchope'))
