...
class Admin_Theme_Element_SidebarDelete extends Admin_Theme_Menu_Element
{
	...
	public function render()
	{
		...
		<input type="submit" name="sidebar_rm_<?php echo $i; ?>" id="<?php echo $i; ?>" class="button" value="<?php _e('Delete','churchope'); ?>" />
		<img class="sidebar_rm_<?php echo $i; ?>" style="display:none;" src="images/wpspin_light.gif" alt="<?php _e('Loading','churchope'); ?>" />
